...
Blueprint.prototype.install = function(options) {
  ...
  return Promise.resolve()
    ...
    .then(function(customLocals){ 
      return this._locals(options, customLocals);
    }.bind(this))
    .then(function(locals){
      var promise = this.beforeInstall(options);
...
Blueprint.prototype.uninstall = function(options) {
  ...
  return Promise.resolve()
    ...
    .then(function(locals){
      var promise = this.beforeUninstall(options);
      if(promise && promise.then){
        return promise.then(function(){
          return locals;
        });
...
/**
  ...
  @return {Object}
*/
Blueprint.prototype._locals = function(options, customLocals){
